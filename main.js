...
import Pino from 'pino'
import { CHERRYBOTJadiBot } from './plugins/jadibot-serbot.js'
...
CHERRYBOTJadiBot({pathCHERRYBOTJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
