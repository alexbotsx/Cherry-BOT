...
import Pino from 'pino'
import { ApoloBotJadiBot } from './plugins/jadibot-serbot.js'
...
ApoloBotJadiBot({pathApoloBotJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
